# Funchal — 6 au 10 septembre 2026

Magnolia Residence, Lido / Rua Dr. Pita (2 chambres). Check-out **vendredi 11 matin**. 2 adultes, **sans voiture** : bus SIGA + marche.

**Ne pas** caser ici : PR1, PR10, PR6 / 25 Fontes, PR13 — c’est la traverse 11–16. Pas de day-trip Rabaçal.

Tu **ne réserves pas** les restos. **PR1 = déjà booké.** Il reste à booker **toi-même** **PR8 (lun 7)** et **PR9 (mer 9)** sur [SIMplifica](https://simplifica.madeira.gov.pt) (se vendent). Relire chaque PDF SIGA **la veille**.
...
| --- | --- |
| **SIMplifica** | Non |
| **Bus** | **Aerobus 500** aéroport (arrêt 01) → **Lido (arrêt 15)** ~38 min, puis 10 min à pied en montée jusqu’au Magnolia. Cash à bord. Dimanche : 08:30 · 09:00 · 09:30 · 10:30 · 11:30 · 12:00 · 14:00 … dernier **22:00**. [Page Aerobus](https://siga.madeira.gov.pt/aerobus) · [horaires PDF](https://siga.madeira.gov.pt/img/aerobus/aerobus_2.pdf) (en vigueur 1er avr. 2026) · [FNC transports](https://www.aeroportomadeira.pt/pt/fnc/acesso-e-estacionamento/chegar-e-sair-do-aeroporto/transportes-publicos) |

**Matin / arrivée.** Descendre Lido ou Estrada Monumental 12–14 (le Magnolia n’est pas dans la liste hôtels A–Z). Monter Rua Dr. Pita → Beco da Quinta da Fe 24. Check-in, douche.
...
**Pluie / vent fort.** PR8 = arêtes exposées : **on n’y va pas**. Repli : Museu da Baleia au Caniçal si tu es déjà à l’est, ou Machico plage + 701 retour ; sinon journée musées Funchal. Reporter PR8 au **mardi** (pas mercredi — PR9) **seulement si** le créneau SIMplifica peut être **déplacé** (remboursement IFCN surtout si *eux* ferment le sentier). 2ᵉ repli : jeudi.
...
| --- | --- |
| **SIMplifica** | Non |
| **Bus** | **008** Magnolia → Centro (Praça do Povo / Av. do Mar). Fréquent dès ~05:45. [PDF 008](https://siga.madeira.gov.pt/public/storage/horarios_pdf/3CA4A08D-34DD-4EA6-BBA3-13C7E3D24B8A.pdf) |

**Matin.** Mercado dos Lavradores **tant qu’il y a encore du marché** (viser avant midi ; l’après-midi c’est surtout des étals touristes). Sé, Avenida Arriaga, jardins municipaux. Café en terrasse — ne pas enchaîner trois musées.
...
**Option mer (si vous la prenez).** Réserve de **Garajau** — le spot des mérous. Dernière plongée = cours OW **il y a 1 an** → pas un fun dive bateau (souvent 6 plongées loguées + plongée < 12 mois). Toi = **PADI ReActivate €79** (briefing + piscine + plongée mer, kit inclus, ~demi-journée). Frère = **Discover Scuba €79** (même structure, max 12 m). Même centre, même matin — **pas** buddy. [Azul](https://www.azuldiving.com/refresh-course) · Penha França Mar, Rua Carvalho Araújo 1 · WhatsApp **+351 914 256 575**. Dire : *OW last dive = course 1 year ago → ReActivate. Brother never dived → Discover Scuba. Same morning 8 Sep, ocean dive Garajau if possible.* Carte OW + logbook. Frère : nager + questionnaire médical. eLearning ReActivate optionnel +€45. Repli : **jeu 10** matin (pas ven 18 — 12 h sans avion). Pas l’épave Afonso.

---

## Mercredi 9 — PR9 Caldeirão Verde

Journée entière, nord. Départ Queimadas. Tunnels = **frontale**. **Booker SIMplifica.** Fiche : [../sentiers/pr9.md](../sentiers/pr9.md).

| | |
| --- | --- |
| **SIMplifica** | **Oui.** [Portal](https://simplifica.madeira.gov.pt). **€4,50** / pers. Fenêtre 30 min à **Queimadas**. QR hors-ligne |
| **Bus + taxi** | **008** → CAM → **801** Funchal–Santana (ex-56). Relire [réseau Santana](https://siga.madeira.gov.pt/horarios/5000) **mardi soir**. Puis taxi Santana → Queimadas A/R (**+351 291 572 540**). Pas de bus à la porte |

**Matin.** Créneau ~10:00–10:30 sauf 801 très tôt. Aller-retour jusqu’à la cascade. **Pas** Caldeirão do Inferno le même jour.

**Après-midi.** Taxi + 801 retour Funchal. Checker le **dernier 801** avant de quitter la levada.

**Soir.** Lido, jambes en l’air. Pas de Girão aujourd’hui.

**Pluie.** Reporter. Repli : Câmara de Lobos + Cabo Girão (€5 miradouro, pas un PR).
...
## À sauter (pièges / doublon GR1)

- **PR6 25 Fontes, PR1, PR10, PR13** depuis Funchal — trop loin / déjà sur la traverse. **PR8 et PR9 = oui**, semaine 7–10.
- **Curral das Freiras** en day-trip — vallée en bus pour un décor que la traverse donne mieux.
- **Pico do Areeiro selfie-bus** — tu y vas **pour de vrai** le 13.
- **Musée CR7**, **Yellow Bus** hop-on, **luge du Monte** comme « il faut » (un shot max, c’est du folklore payant).
- **Monte Palace** *et* Jardim Botânico le même jour — jardins chers en doublon ; garder le Botânico IFCN.
- **Porto Santo** (ferry) — une journée entière pour une autre île.
- Location de voiture « juste 4 jours » — casse le plan bus du 11.
...
## Retour Funchal — 17–18 (après le GR1)

Checkout PM **jeu 17**. Nuits **17–18**, checkout **sam 19 matin**. **Pas Magnolia** (indispo 17–20 au check ; rechecker 17–19). Centre (Bella Vista) ou **Lido** (Alto Lido) si vol tôt.
...
**Pluie.** Blandy’s / Arte Sacra / mall. Same as 6–10.
